...
int tongDong(int mt[][COL], int m, int n);
int tongCot(int mt[][COL], int m, int n);
...
int main()
{
    ...
    cin >> r;
    cout << "Tong dong: " << r << " la " << tongDong(mt, r, nCol) << endl;

    // tinh dong cot
    int c;
    cout << "Nhap cot can tinh tong: ";
    cin >> c;
    cout << "Tong cot: " << c << " la " << tongCot(mt, nRow, c) << endl;
}
